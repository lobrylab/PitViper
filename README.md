...
```bash
# Install dependencies using Mamba and use the YAML configuration file, run flask application.
$ ./run.sh

# Install dependencies using Conda and use the lock YAML configuration file (generated by conda-lock), run flask application.
$ ./run.sh --installer conda --mode lock

# Install dependencies using Mamba and use the YAML configuration file, run flask application.
$ ./run.sh --installer mamba --mode yaml

# Install dependencies using Mamba and use the YAML configuration file but don't run flask application
$ ./run.sh --noflask
```
